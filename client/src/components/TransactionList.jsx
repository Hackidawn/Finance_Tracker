...
const TransactionList = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.setFontSize(18);
    doc.text('Personal Finance Tracker - Bill', 14, 20);
    ...
    doc.setFontSize(12);
    doc.text(`Total Income: ₹${incomeTotal}`, 14, doc.lastAutoTable.finalY + 10);
    doc.text(`Total Expense: ₹${expenseTotal}`, 14, doc.lastAutoTable.finalY + 20);

    doc.setFontSize(10);
    doc.text('Generated by Personal Finance Tracker', 14, doc.lastAutoTable.finalY + 35);
